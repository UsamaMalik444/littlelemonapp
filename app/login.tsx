      ...
      <View style={loginStyles.form}>
        ...
        <Controller
          ...
          render={({ field: { onChange, onBlur, value } }) => (
            <CustomTextInput onChangeText={onChange} onBlur={onBlur} placeholder='User' value={value} variant='dark'/>
          )}
          name="username"
        />
        ...
        <Controller
          ...
          render={({ field: { onChange, onBlur, value } }) => (
            <CustomTextInput onChangeText={onChange} onBlur={onBlur} placeholder='12345' value={value} variant='dark' secureTextEntry />
          )}
